...
from .dispenserusage_schemas import BaseDomainValueError

class DispenserUsageValueError(BaseDomainValueError):
    """Error de valor en atributos de la entidad DispenserUsage."""
