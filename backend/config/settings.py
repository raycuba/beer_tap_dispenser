...
SECRET_KEY = 'django-insecure-l7xcn+e*$pcp9)!7cd@+f2o07xpgfc9n0a!z4=fvljfmlq+y&7'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'beertap_db'),
...
# Configuración para que DRF genere la documentación Swagger automáticamente
REST_FRAMEWORK = {
